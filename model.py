...
class LinearWarmupScheduler(_LRScheduler):
    ...
    def get_lr(self):
        if self.last_epoch < self.num_warmup_steps:
            ...
            return [base_lr * ((self.num_training_steps - self.last_epoch) / (self.num_training_steps - self.num_warmup_steps)) for base_lr in self.base_lrs]
