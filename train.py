...
def train(gpu,
    ...
    trainer = Trainer(gpus=gpu,
                    distributed_backend=None, #'ddp' if not isinstance(gpu,list) else None,
                    logger=[wb,csv_log],
...
if __name__ == "__main__":
    ...
    models = ["allenai/scibert_scivocab_uncased","bert-base-uncased"] # add models to get accuracy
